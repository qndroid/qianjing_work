...
public class P2pHistoryActivity extends BaseHistoryActivity implements OnClickListener{
	...
	private P2pHistoryFragment assemable1;
	private P2pHistoryFragment assemable2;
	private P2pHistoryFragment assemable3;
	...
	public void initPopupView(View popupowView) {
		...
		popupItem2.setText("投资");
		popupItem3.setText("回款");
	...
	private void setCurrentFragment(int index) {
		...
		case 1:
			if(assemable1==null){
				assemable1 = new P2pHistoryFragment();
		...
		case 2:
			if(assemable2==null){
				assemable2 = new P2pHistoryFragment();
		...
		case 3:
			if(assemable3==null){
				assemable3 = new P2pHistoryFragment();
