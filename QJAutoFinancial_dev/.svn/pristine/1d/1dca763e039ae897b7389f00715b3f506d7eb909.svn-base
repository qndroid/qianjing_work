...
import com.qianjing.finance.widget.pulltorefresh.PullToRefreshBase.OnPullEventListener;
...
import com.qianjing.finance.widget.pulltorefresh.PullToRefreshBase.State;
