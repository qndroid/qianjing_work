...
public class BadgeView extends TextView {
	...
	public static final int ROUND_RECT_SHAPE = 10;
	public static final int OVAL_SHAPE = 11;
	...
	private int badgeMargin1;
	private int badgeMargin2;
	private int badgeColor;
	private int sharpType = ROUND_RECT_SHAPE;
	...
	private void init(Context context, View target, int tabIndex) {
		...
		badgeMargin1 = dipToPixels(DEFAULT_MARGIN_DIP);
		badgeMargin2 = dipToPixels(DEFAULT_MARGIN_DIP);
	...
	private void applyLayoutParams() {
		...
		case POSITION_TOP_LEFT:
			...
			lp.setMargins(badgeMargin1, badgeMargin2, 0, 0);
			break;
		case POSITION_TOP_RIGHT:
			lp.gravity = Gravity.RIGHT | Gravity.TOP;
			lp.setMargins(0, badgeMargin1, badgeMargin2, 0);
			break;
		case POSITION_BOTTOM_LEFT:
			lp.gravity = Gravity.LEFT | Gravity.BOTTOM;
			lp.setMargins(badgeMargin1, 0, 0, badgeMargin2);
			break;
		case POSITION_BOTTOM_RIGHT:
			lp.gravity = Gravity.RIGHT | Gravity.BOTTOM;
			lp.setMargins(0, 0, badgeMargin1, badgeMargin2);
			break;
		default:
			break;
		}
     ...
     */
	public void setBadgeMargin2(int badgeMargin) {
		this.badgeMargin2 = badgeMargin;
	}
     ...
     * @param badgeMargin the margin in pixels.
     */
	public void setBadgeMargin1(int badgeMargin) {
		this.badgeMargin1 = badgeMargin;
	}
